  ...
  menuPrincipal: {
    menu: [
      ...
      },
      {
        ...
        icono: 'far fa-file-alt',
        numero: '3',
        titulo: 'Aplicaciones geométricas en problemas cotidianos',
        desarrolloContenidos: true,
        subMenu: [
          {
            icono: 'far fa-file-alt',
            numero: '3.1',
            titulo: 'Geometría básica en construcciones y diseño',
            hash: 't_3_1',
          },
          {
            icono: 'far fa-file-alt',
            numero: '3.2',
            titulo: 'Geometría en navegación y cartografía',
            hash: 't_3_2',
          },
          {
            icono: 'far fa-file-alt',
            numero: '3.3',
            titulo: 'Geometría en tecnología y diseño digital',
            hash: 't_3_3',
          },
        ],
      },
